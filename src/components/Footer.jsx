    ...
    <footer className="bg-neutral-950">
      <div className="mx-auto max-w-7xl px-5 sm:px-6 pt-14 sm:pt-16 pb-10">
        ...
        <div className="mt-6 text-center text-xs text-white/45">
          ...
          <a target="_blank" className="text-[#00cf77] font-bold" href="https://www.instagram.com/arpextechnology?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==">ArpeX</a>.
        </div>
      </div>
    </footer>
  );
